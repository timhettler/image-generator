angular.module('bragBag')
  .factory('ytImageGenerator', function ($rootScope) {
    // private variables
    var _self = this,
        $canvas = $('<canvas/>'),
        _canvasTarget,
    ...
    Object.defineProperty(_self.params, 'canvasTarget', {
      get: function() { return _canvasTarget; },
      set: function (selector) {
        _canvasTarget = $(selector);
        _canvasTarget.append($canvas);
      }
    });
      ...
      _loadedPromise = new Promise (function (resolve, reject) {
        ...
        //_self.fetchSvg(_self.svgUrl).then(function (svg) {
          ...
          _xcanvas.compile (_self.svg, function () {
            ...
            $rootScope.$broadcast('ytImageGenerator:ready', _self);
            resolve();
          });
        //});
      });
